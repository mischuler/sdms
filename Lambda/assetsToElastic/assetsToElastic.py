...
ES_ENDPOINT = 'search-hank-6twba3vhs6beld5vm2d3wixuru.us-east-1.es.amazonaws.com' # This should be environmental
...
def post_data_to_es(payload, region, creds, host, path, method='POST', proto='https://'):
    ...
    params = {
        ...
        'headers': {
            'Host': host,
            'Content-Type': 'application/json' # NEW TO SUPPORT ES6
        }, 
        'body': payload
    }
    ...
    http_session = botocore.endpoint.BotocoreHTTPSession()
