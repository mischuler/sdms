...
def runTest(args):
    ...
    ARN = "arn:aws:states:us-east-1:343744686176:stateMachine:IPD"
...
def delTest(args):
    ...
    ARN = "arn:aws:states:us-east-1:343744686176:stateMachine:deleteAsset"
